...
public class RNAPolymeraseTest {
    ...
    public void should_create_mRNA_from_DNA_with_sense_strand() {
        assertThat(new RNAPolymerase().transcribe(new Sense(List.of(ADENINE, THYMINE, GUANINE, CYTOSINE, THYMINE, GUANINE)), 0, 6))
    ...
    public void should_create_mRNA_from_DNA_with_antisense_strand() {
        assertThat(new RNAPolymerase().transcribe(new Antisense(List.of(ADENINE, THYMINE, GUANINE, CYTOSINE, ADENINE, THYMINE, CYTOSINE, THYMINE, GUANINE)), 3, 9))
    ...
    public void should_raise_error_when_DNA_gene_is_not_divisible_by_three() {
        new RNAPolymerase().transcribe(new Antisense(List.of(ADENINE, THYMINE, GUANINE, CYTOSINE)), 0, 4);
    }
}
